...
{
    public static class GetGeoLocationByIPV4RestSdkExample
    {
        public static void Go(string licenseKey, bool isLive)
        {
            Console.WriteLine("\r\n-------------------------------------------------------");
            Console.WriteLine("IP Address Validation - GetGeoLocationByIPV4 - REST SDK");
            Console.WriteLine("-------------------------------------------------------");
            ...
            Console.WriteLine("\r\n* Input *\r\n");
            Console.WriteLine($"IP Address : {getGeoLocationInput.IPAddress}");
